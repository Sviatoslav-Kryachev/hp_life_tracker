...
from app.models.base import Streak, ActivityLog, XPWallet


class StreakService:
    """Сервис для работы с сериями (streak)"""
    ...
    @staticmethod
    def update_streak(db: Session, user_id: int) -> Dict[str, Any]:
    ...
    @staticmethod
    def get_streak(db: Session, user_id: int) -> Dict[str, Any]:
