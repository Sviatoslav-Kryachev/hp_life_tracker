...
from app.models.base import XPWallet, ActivityLog, RewardPurchase, TimerLog, Activity


class XPService:
    """Сервис для работы с XP, кошельком и статистикой"""
    
    @staticmethod
    def get_wallet(db: Session, user_id: int) -> Dict[str, Any]:
        """Получить кошелёк XP пользователя"""
    ...
    @staticmethod
    def earn_xp(db: Session, user_id: int, activity_log_id: int) -> Dict[str, Any]:
    ...
    @staticmethod
    def get_xp_history(db: Session, user_id: int, limit: int = 20) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def get_today_stats(db: Session, user_id: int) -> Dict[str, Any]:
    ...
    @staticmethod
    def get_week_stats(db: Session, user_id: int) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def get_month_stats(db: Session, user_id: int) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def get_year_stats(db: Session, user_id: int) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def get_day_details(db: Session, user_id: int, date: str) -> Dict[str, Any]:
    ...
    @staticmethod
    def get_full_history(db: Session, user_id: int, limit: int = 50) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def get_category_stats(db: Session, user_id: int, period: str = "week") -> Dict[str, Any]:
